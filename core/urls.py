...
urlpatterns = [
    ...
    # 🔥 ADDED: Redirect from plural 'items/' to singular 'item/'
    path('items/<uuid:item_id>/', RedirectView.as_view(pattern_name='core:item_detail', permanent=True)),
    ...
    # Newsletter API endpoints - For footer JavaScript
